...
// orde of custom middleware and built in middleware is important as they are executed in the order they are defined or sequentially
// 1. import express
...
// Error handling middleware can be added here as well
app.use((err, req, res, next) => {
    console.error(err.stack);
    res.status(500).send('Something broke!');
});  

// Below is the flow of request handling in this server setup
